...
/**
 * NsPangoLayoutSerializeFlags:
 * @NS_PANGO_LAYOUT_SERIALIZE_DEFAULT: Default behavior
 * @NS_PANGO_LAYOUT_SERIALIZE_CONTEXT: Include context information
 * @NS_PANGO_LAYOUT_SERIALIZE_OUTPUT: Include information about the formatted output
 *
 ...
 */
typedef enum {
  NS_PANGO_LAYOUT_SERIALIZE_DEFAULT = 0,
  NS_PANGO_LAYOUT_SERIALIZE_CONTEXT = 1 << 0,
  NS_PANGO_LAYOUT_SERIALIZE_OUTPUT = 1 << 1,
} NsPangoLayoutSerializeFlags;

NS_PANGO_AVAILABLE_IN_1_50
GBytes *        ns_pango_layout_serialize             (NsPangoLayout                *layout,
                                                    NsPangoLayoutSerializeFlags   flags);

NS_PANGO_AVAILABLE_IN_1_50
gboolean        ns_pango_layout_write_to_file         (NsPangoLayout                 *layout,
                                                    NsPangoLayoutSerializeFlags   flags,

                                                    const char                  *filename,
                                                    GError                     **error);

#define NS_PANGO_LAYOUT_DESERIALIZE_ERROR (ns_pango_layout_deserialize_error_quark ())

/**
 * NsPangoLayoutDeserializeError:
 * @NS_PANGO_LAYOUT_DESERIALIZE_INVALID: Unspecified error
 * @NS_PANGO_LAYOUT_DESERIALIZE_INVALID_VALUE: A JSon value could not be
 *   interpreted
 * @NS_PANGO_LAYOUT_DESERIALIZE_MISSING_VALUE: A required JSon member was
 *   not found
 *
 ...
 */
typedef enum {
  NS_PANGO_LAYOUT_DESERIALIZE_INVALID,
  NS_PANGO_LAYOUT_DESERIALIZE_INVALID_VALUE,
  NS_PANGO_LAYOUT_DESERIALIZE_MISSING_VALUE,
} NsPangoLayoutDeserializeError;

NS_PANGO_AVAILABLE_IN_1_50
GQuark          ns_pango_layout_deserialize_error_quark (void);

/**
 * NsPangoLayoutDeserializeFlags:
 * @NS_PANGO_LAYOUT_DESERIALIZE_DEFAULT: Default behavior
 * @NS_PANGO_LAYOUT_DESERIALIZE_CONTEXT: Apply context information
 *   from the serialization to the `NsPangoContext`
 *
 ...
 */
typedef enum {
  NS_PANGO_LAYOUT_DESERIALIZE_DEFAULT = 0,
  NS_PANGO_LAYOUT_DESERIALIZE_CONTEXT = 1 << 0,
} NsPangoLayoutDeserializeFlags;

NS_PANGO_AVAILABLE_IN_1_50
NsPangoLayout *   ns_pango_layout_deserialize           (NsPangoContext                 *context,
                                                    GBytes                       *bytes,
