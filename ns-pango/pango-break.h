 ...
 *
 * The `NsPangoLogAttr` structure stores information about the attributes of a
 * single character.
 */
...
void                    ns_pango_break             (const char    *text,
                                                 int            length,
...
void                    ns_pango_get_log_attrs     (const char    *text,
                                                 int            length,
                                                 int            level,
...
NS_PANGO_AVAILABLE_IN_ALL
void                    ns_pango_default_break     (const char    *text,
                                                 int            length,
                                                 NsPangoAnalysis *analysis,
                                                 NsPangoLogAttr  *attrs,
                                                 int            attrs_len);
...
void                    ns_pango_tailor_break      (const char    *text,
                                                 int            length,
                                                 NsPangoAnalysis *analysis,
                                                 int            offset,
                                                 NsPangoLogAttr  *attrs,
...
void                    ns_pango_attr_break        (const char    *text,
                                                 int            length,
