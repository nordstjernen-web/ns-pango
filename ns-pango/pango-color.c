...
G_DEFINE_BOXED_TYPE (NsPangoColor, ns_pango_color,
                     ns_pango_color_copy,
                     ns_pango_color_free);
 ...
 * in C).
 *
 * Return value: (nullable): the newly allocated `NsPangoColor`,
 *   which should be freed with [method@Pango.Color.free]
 */
NsPangoColor*
ns_pango_color_copy (const NsPangoColor *src)
{
  NsPangoColor *ret;
...
/**
 * ns_pango_color_free:
 * @color: (nullable): an allocated `NsPangoColor`
 *
 * Frees a color allocated by [method@Pango.Color.copy].
 */
void
ns_pango_color_free (NsPangoColor *color)
{
  if (color == NULL)
    return;

  g_slice_free (NsPangoColor, color);
}

/**
 * ns_pango_color_to_string:
 * @color: a `NsPangoColor`
 *
 ...
 */
gchar *
ns_pango_color_to_string (const NsPangoColor *color)
{
...
/**
 * ns_pango_color_parse_with_alpha:
 * @color: (nullable): a `NsPangoColor` structure in which
 *   to store the result
 ...
 */
gboolean
ns_pango_color_parse_with_alpha (NsPangoColor *color,
                              guint16    *alpha,
                              const char *spec)
{
 ...
 */
gboolean
ns_pango_color_parse (NsPangoColor *color,
                   const char *spec)
{
  return ns_pango_color_parse_with_alpha (color, NULL, spec);
}
