 ...
 *
 * This is similar to the macro %NS_PANGO_VERSION except that the macro
 * returns the encoded version available at compile-time. A version
 * number can be encoded into an integer using NS_PANGO_VERSION_ENCODE().
 *
 ...
 */
int
ns_pango_version (void)
{
  return NS_PANGO_VERSION;
}
 ...
 *
 * This is similar to the macro %NS_PANGO_VERSION_STRING except that the
 ...
 */
const char *
ns_pango_version_string (void)
{
  return NS_PANGO_VERSION_STRING;
}
 ...
 * given version.
 *
 * Generally you would pass in the constants %NS_PANGO_VERSION_MAJOR,
 * %NS_PANGO_VERSION_MINOR, %NS_PANGO_VERSION_MICRO as the three arguments
 ...
 * (same major version.)
 *
 * For compile-time version checking use NS_PANGO_VERSION_CHECK().
 *
 ...
 */
const gchar*
ns_pango_version_check (int required_major,
		     int required_minor,
		     int required_micro)
{
  gint ns_pango_effective_micro = 100 * NS_PANGO_VERSION_MINOR + NS_PANGO_VERSION_MICRO;
  gint required_effective_micro = 100 * required_minor + required_micro;

  if (required_major > NS_PANGO_VERSION_MAJOR)
    return "Pango version too old (major mismatch)";
  if (required_major < NS_PANGO_VERSION_MAJOR)
    return "Pango version too new (major mismatch)";
  if (required_effective_micro < ns_pango_effective_micro - NS_PANGO_BINARY_AGE)
    return "Pango version too new (micro mismatch)";
  if (required_effective_micro > ns_pango_effective_micro)
    return "Pango version too old (micro mismatch)";
  return NULL;
}

/**
 * ns_pango_trim_string:
 * @str: a string
 *
 ...
 */
char *
ns_pango_trim_string (const char *str)
{
  return _ns_pango_trim_string (str);
}

char *
_ns_pango_trim_string (const char *str)
{
  int len;
 ...
 */
char **
ns_pango_split_file_list (const char *str)
{
  int i = 0;
  int j;
  char **files;
  ...
  while (files[i])
    {
      char *file = _ns_pango_trim_string (files[i]);
 ...
 */
gint
ns_pango_read_line (FILE *stream, GString *str)
{
 ...
 */
gboolean
ns_pango_skip_space (const char **pos)
{
  const char *p = *pos;
 ...
 */
gboolean
ns_pango_scan_word (const char **pos, GString *out)
{
  const char *p = *pos;
 ...
 */
gboolean
ns_pango_scan_string (const char **pos, GString *out)
{
  const char *p = *pos;
 ...
 */
gboolean
ns_pango_scan_int (const char **pos, int *out)
{
  return _ns_pango_scan_int (pos, out);
}

gboolean
_ns_pango_scan_int (const char **pos, int *out)
{
  char *end;
  long temp;
...
/**
 * ns_pango_config_key_get_system:
 ...
 */
char *
ns_pango_config_key_get_system (const char *key)
{
  return NULL;
}

/**
 * ns_pango_config_key_get:
 * @key: Key to look up, in the form "SECTION/KEY"
 *
 * Do not use.  Does not do anything.
 *
 ...
 */
char *
ns_pango_config_key_get (const char *key)
{
  return NULL;
}

/**
 * ns_pango_get_sysconf_subdirectory:
 *
 ...
 */
const char *
ns_pango_get_sysconf_subdirectory (void)
{
  ...
  if (g_once_init_enter (&result))
    {
      ...
      const char *sysconfdir = g_getenv ("NS_PANGO_SYSCONFDIR");
      if (sysconfdir != NULL)
 ...
 */
const char *
ns_pango_get_lib_subdirectory (void)
{
  static const gchar *result = NULL; /* MT-safe */
  ...
  if (g_once_init_enter (&result))
    {
      ...
      const char *libdir = g_getenv ("NS_PANGO_LIBDIR");
      if (libdir != NULL)
...
/**
 * ns_pango_parse_enum:
 * @type: enum type to parse, eg. %NS_TYPE_PANGO_ELLIPSIZE_MODE
 ...
 */
gboolean
ns_pango_parse_enum (GType       type,
		  const char *str,
		  int        *value,
		  gboolean    warn,
		  char      **possible_values)
{
  return _ns_pango_parse_enum (type, str, value, warn, possible_values);
}

gboolean
_ns_pango_parse_enum (GType       type,
		   const char *str,
 		   int        *value,
		   gboolean    warn,
		   char      **possible_values)
...
gboolean
ns_pango_parse_flags (GType        type,
                   const char  *str,
                   int         *value,
                   char       **possible_values)
{
 ...
 */
void
ns_pango_lookup_aliases (const char   *fontname,
		      char       ***families,
		      int          *n_families)
{
  *families = NULL;
 ...
 *   If no such character is found, then %NS_PANGO_DIRECTION_NEUTRAL is returned.
 *
 * Since: 1.4
 */
NsPangoDirection
ns_pango_find_base_dir (const gchar *text,
		     gint         length)
{
  NsPangoDirection dir = NS_PANGO_DIRECTION_NEUTRAL;
  const gchar *p;

  g_return_val_if_fail (text != NULL || length == 0, NS_PANGO_DIRECTION_NEUTRAL);
  ...
  while ((length < 0 || p < text + length) && *p)
    {
      ...
      dir = ns_pango_unichar_direction (wc);

      if (dir != NS_PANGO_DIRECTION_NEUTRAL)
	break;
 ...
 */
gboolean
ns_pango_is_zero_width (gunichar ch)
{
...
/**
 * ns_pango_quantize_line_geometry:
 ...
 */
void
ns_pango_quantize_line_geometry (int *thickness,
			      int *position)
{
  int thickness_pixels = (*thickness + NS_PANGO_SCALE / 2) / NS_PANGO_SCALE;
  if (thickness_pixels == 0)
    thickness_pixels = 1;

  if (thickness_pixels & 1)
    {
      int new_center = ((*position - *thickness / 2) & ~(NS_PANGO_SCALE - 1)) + NS_PANGO_SCALE / 2;
      *position = new_center + (NS_PANGO_SCALE * thickness_pixels) / 2;
    }
  else
    {
      int new_center = ((*position - *thickness / 2 + NS_PANGO_SCALE / 2) & ~(NS_PANGO_SCALE - 1));
      *position = new_center + (NS_PANGO_SCALE * thickness_pixels) / 2;
    }

  *thickness = thickness_pixels * NS_PANGO_SCALE;
}

/**
 * ns_pango_units_from_double:
 * @d: double floating-point value
 *
 * Converts a floating-point number to Pango units.
 *
 * The conversion is done by multiplying @d by %NS_PANGO_SCALE and
 ...
 */
int
ns_pango_units_from_double (double d)
{
  return (int)floor (d * NS_PANGO_SCALE + 0.5);
}

/**
 * ns_pango_units_to_double:
 * @i: value in Pango units
 *
 * Converts a number in Pango units to floating-point.
 *
 * The conversion is done by dividing @i by %NS_PANGO_SCALE.
 *
 ...
 */
double
ns_pango_units_to_double (int i)
{
  return (double)i / NS_PANGO_SCALE;
}

/**
 * ns_pango_extents_to_pixels:
 ...
 *
 * The conversion is done by dividing by the %NS_PANGO_SCALE factor and
 * performing rounding.
 *
 ...
 */
void
ns_pango_extents_to_pixels (NsPangoRectangle *inclusive,
  ...
  if (inclusive)
    {
      ...
      inclusive->x = NS_PANGO_PIXELS_FLOOR (inclusive->x);
      inclusive->y = NS_PANGO_PIXELS_FLOOR (inclusive->y);

      inclusive->width  = NS_PANGO_PIXELS_CEIL (orig_x + inclusive->width ) - inclusive->x;
      inclusive->height = NS_PANGO_PIXELS_CEIL (orig_y + inclusive->height) - inclusive->y;
    }
  ...
  if (nearest)
    {
      ...
      nearest->x = NS_PANGO_PIXELS (nearest->x);
      nearest->y = NS_PANGO_PIXELS (nearest->y);

      nearest->width  = NS_PANGO_PIXELS (orig_x + nearest->width ) - nearest->x;
      nearest->height = NS_PANGO_PIXELS (orig_y + nearest->height) - nearest->y;
    }
}
...

/*********************************************************
 * Some internal functions for handling NS_PANGO_ATTR_SHAPE *
 ********************************************************/

void
_ns_pango_shape_shape (const char       *text,
		    unsigned int      n_chars,
		    NsPangoRectangle   *shape_ink G_GNUC_UNUSED,
		    NsPangoRectangle   *shape_logical,
		    NsPangoGlyphString *glyphs)
{
  unsigned int i;
  const char *p;

  ns_pango_glyph_string_set_size (glyphs, n_chars);

  for (i=0, p = text; i < n_chars; i++, p = g_utf8_next_char (p))
    {
      glyphs->glyphs[i].glyph = NS_PANGO_GLYPH_EMPTY;
...
void
_ns_pango_shape_get_extents (gint              n_chars,
			  NsPangoRectangle   *shape_ink,
			  NsPangoRectangle   *shape_logical,
...
/**
 * ns_pango_find_paragraph_boundary:
 * @text: UTF-8 text
 ...
 */
void
ns_pango_find_paragraph_boundary (const char *text,
                               int         length,
